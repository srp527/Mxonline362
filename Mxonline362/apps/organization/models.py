...
class CourseOrg(models.Model):
    ...
    image = models.ImageField(upload_to='org/%Y/%m', verbose_name=u'logo图', max_length=100)
    ...
    def get_teacher_nums(self): #获取课程机构的讲师数量
        return self.teacher_set.all().count()

    def get_hot_course(self):   #获取机构中点击量前两个的课程
